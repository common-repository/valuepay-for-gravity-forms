...
abstract class Valuepay_GF_Client {
    ...
    private function get_formatted_error_message( $error_code ) {
        ...
        $errors = array(
            'WS00' => __( 'Request executed successfully.', 'valuepay-gf' ),
            'WS01' => __( 'Invalid endpoint', 'valuepay-gf' ),
            'WS02' => __( 'No request body', 'valuepay-gf' ),
            'WS03' => __( 'Data is not properly formatted', 'valuepay-gf' ),
            'E01' => __( 'Missing mandatory field', 'valuepay-gf' ),
            'E02' => __( 'Collection missing mandatory field for open bill amount', 'valuepay-gf' ),
            'E03' => __( 'Collection missing mandatory field for fixed number amount', 'valuepay-gf' ),
            'E04' => __( 'Collection value not valid amount', 'valuepay-gf' ),
            'E05' => __( 'Collection alias is not available', 'valuepay-gf' ),
            'E06' => __( 'Collection mandatory field indicator is not valid', 'valuepay-gf' ),
            'E07' => __( 'Unable to cancel collection or bill', 'valuepay-gf' ),
            'E08' => __( 'Unable to delete in-flight transaction. There is pending payment intent for this bill.', 'valuepay-gf' ),
            'E09' => __( 'Invalid or inactive collection ID or mandate ID', 'valuepay-gf' ),
            'E10' => __( 'Invalid bill ID', 'valuepay-gf' ),
            'E11' => __( 'Invalid payment intent ID', 'valuepay-gf' ),
            'E12' => __( 'Invalid merchant username or not active', 'valuepay-gf' ),
            'E13' => __( 'Invalid reqhash calculation', 'valuepay-gf' ),
            'E14' => __( 'Missing mandatory field for API', 'valuepay-gf' ),
            'E15' => __( 'Billing amount is not valid', 'valuepay-gf' ),
            'E16' => __( 'Billing buyer data field is not valid', 'valuepay-gf' ),
            'E17' => __( 'Billing mobile number missing country code or invalid length', 'valuepay-gf' ),
            'E18' => __( 'Billing e-mail address is invalid', 'valuepay-gf' ),
            'E19' => __( 'Billing order number length exceed limit', 'valuepay-gf' ),
            'E20' => __( 'Billing frontend or backend URL format is not valid or unsecured', 'valuepay-gf' ),
            'E21' => __( 'Billing frontend or backend URL certificate cannot be verified with CA', 'valuepay-gf' ),
        );
